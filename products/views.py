...
def show_product(request):
  ...
  full_description = """
                    ...
                    <p>
                      Sound of Marshall, unplugs the chords, and takes the show
                      on the road.
                    </p>
                    <p>
                      Weighing in under 7 pounds, the Kilburn is a lightweight
                    ...
                    <p>
                      ...
                      feature due for retirement – the S6 had it, then the Note5
                      didn’t, and now with the S7 the trend is clear.
                    </p>
                    <h5>Perfectly Done</h5>
                    <p>
                      Meanwhile, the IP68 water resistance has improved from the
                      S5, allowing submersion of up to five feet for 30 minutes,
                    ...
                    <p>
                      ...
                      hasn’t reinvented the wheel with the design of the Galaxy
                      S7, but it didn’t need to. The Gala S6 was an excellently
                      styled device, and the S7 has managed to improve on that.
                    </p>
  """
  context={'short_description':short_description,'full_description':full_description}
  return render(request, "products/product-box.html",context)
def show_product_on_sale(request):
    return render(request, "products/product-on-sale.html")